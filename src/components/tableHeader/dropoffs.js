...
import { loadDropOffsStart, searchDropOffStart, sortDropOffStart } from "../../redux/action/dropoff_actions";
...
const DropOffHeader = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(searchDropOffStart(searchTerm));
    setSearchTerm("");
  }
  //End New
        ...
        <div className="section-title">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button 
              ...
              onClick={() => 
                dispatch(loadDropOffsStart({start: 0, end: 4, currentPage: 0}))
              }
            >
                Reset
            </button>

            <Link to="/add-dropoff" className="addLink form-item">
              Add Dropoff
            </Link>
          </form>
      </div>
